...
const KingsNight = () => {
    const items = [
        ...
        {
            title: 'KINGS NIGHT FOR FREE',
            description: 'The King goes free when you book this package! It’s only right.',
        },
    ];
            ...
            <div className="relative md:h-screen w-full overflow-hidden">
                ...
                <div className="relative z-20 flex flex-col items-center justify-center text-center px-4 py-20 text-white">
                    ...
                    <div className="relative z-20 mt-8 flex flex-col items-center">
                        <h1 className="text-white text-3xl sm:text-[64px] font-bold mb-4 uppercase tracking-tighter">KINGS NIGHT</h1>
                        {/* <button className="bg-[#00AACB] hover:bg-cyan-700 text-white font-semibold py-2 px-6 rounded text-base sm:text-[26px] mt-4">
      BOOK NOW
    </button> */}
                        <button 
            ...
            <div className="w-full bg-fixed bg-cover bg-center"
                ...
                <section className="text-center pt-12 px-4">
                    <h2 className="text-xl md:text-[36px]  font-bold text-[#292524] mb-4 uppercase leading-tight tracking-wide">
                        CELEBRATE HIS LAST FLING BEFORE <br />THE RING WITH A BOOM
                    </h2>

                    <p className="max-w-4xl mx-auto text-sm md:text-base text-[#292524]">
                        Chat to our expert party planners today to plan a stag party full of fizz and fun. What does the price include?
                    </p>
