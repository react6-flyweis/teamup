...
//                     style={{ backgroundImage: `url(${darts})` }}
//                 ></div>
...
//                                            Ar Darts for up to 6 players per lane for 55 minutes{' '}
...
//                                         <div>
//                                             <p className="text-[20px] max-sm:text-sm text-[#292524] font-medium">Dart Lane for 55 minutes (up to 8 players)</p>
