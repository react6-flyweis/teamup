...
//                                         <div>
//                                             <p className="text-[20px] max-sm:text-sm text-[#292524] font-medium">Nexus Gel Blaster 55 minutes (per person)</p>
