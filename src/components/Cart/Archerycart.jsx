...
//                                         <div>
//                                             <p className="text-[20px] max-sm:text-sm text-[#292524] font-medium">DIGI Archert for 55 minutes (up to 8 players)</p>
//                                             <p className="text-[20px] max-sm:text-sm text-[#292524] font-bold">$45.00</p>
//                                         </div>
