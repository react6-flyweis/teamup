            ...
            <div className="w-full bg-fixed bg-cover bg-center"
                ...
                <section className="text-center pt-12 px-4">
                    ...
                    <p style={{ fontFamily: 'Noir Semi' }} className="max-w-5xl mx-auto text-sm md:text-base text-[#292524]">
                        Our glow-in-the-dark themed mini golf offers a unique and exciting twist on the classic game! With vibrant neon colors, glowing obstacles, and an electric atmosphere, it’s an unforgettable experience for  players of all ages. Whether you're competing with friends or just  enjoying a fun night out, the glowing lights and creative designs make  every hole a thrilling adventure. It’s perfect for those looking to add  some excitement and a bit of magic to their mini golf experience! 
                    </p>
                </section>
    ...
    <div className="bg-black text-[#00AACB] w-full min-[820px]:w-[280px] p-4 space-y-4">
      <div className="flex items-center gap-3">
        ...
        <div style={{ fontFamily: 'Posterama2001W04' }} className="leading-[1.4]">
          ...
          <div className="text-lg min-[820px]:text-xl font-bold mb-2">1-4 Person</div>
          <div className="text-xs min-[820px]:text-sm uppercase">Per Machine</div>
        </div>
      </div>
      <div className="border-b border-[#00AACB] mx-2"></div>
      <div className="flex items-center gap-3">
        <img src={vector} alt="bowling" className="w-auto h-[90px] min-[820px]:h-[105px]" />
        <div style={{ fontFamily: 'Posterama2001W04' }} className="leading-[1.4]">
          <div className="text-xs min-[820px]:text-sm uppercase">How Many Lanes</div>
          <div className="text-lg min-[820px]:text-xl font-bold">8 Lanes</div>
        </div>
      </div>
    </div>
  </motion.div>
