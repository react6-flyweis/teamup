                        ...
                        <div className="bg-black text-[#00AACB] w-full min-[820px]:w-[280px] p-4 space-y-4">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div style={{ fontFamily: 'Posterama2001W04' }} className="leading-[1.4]">
                                    ...
                                    <div className="text-lg min-[820px]:text-xl font-bold">4 Lanes</div>
                                </div>
                            </div>
                        </div>
                    </motion.div>
                        ...
                        <div className="bg-black text-[#00AACB] w-full min-[820px]:w-[280px] p-4 space-y-4">
                            ...
                            <div className="flex items-center gap-6">
                                ...
                                <div style={{ fontFamily: 'Posterama2001W04' }} className="leading-[1.4]">
                                    ...
                                    <div className="text-lg min-[820px]:text-xl font-bold mb-2">9 to 14</div>
                                    <div className="text-xs min-[820px]:text-sm uppercase">6 and Above</div>
                                </div>
                            </div>
                        </div>
                    </motion.div>
