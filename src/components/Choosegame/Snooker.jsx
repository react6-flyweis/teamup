...
import lane from '../../assets/Group 1597883370 (1).svg'
  ...
  >
    <div className="bg-black text-[#00AACB] w-full min-[820px]:w-[280px] p-4 space-y-4">
      ...
      <div className="flex items-center gap-3">
        ...
        <div style={{ fontFamily: 'Posterama2001W04' }} className="leading-[1.4]">
          <div className="text-xs min-[820px]:text-sm uppercase">How Many Tables</div>
          <div className="text-lg min-[820px]:text-xl font-bold">4 tables</div>
        </div>
      </div>
    </div>
  </motion.div>
