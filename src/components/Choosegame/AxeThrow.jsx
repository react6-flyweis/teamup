            ...
            <div className="w-full bg-fixed bg-cover bg-center"
                ...
                <section className="text-center pt-12 px-4">
                    <h2 style={{ fontFamily: 'Posterama2001W04' }} className="text-xl md:text-[44px] font-bold text-[#292524] mb-4 uppercase leading-tight tracking-wide">
                        THE GAME WITH THE GREATEST  AXE-PECTATIONS…
                    </h2>

                    <p style={{ fontFamily: 'Noir Semi' }} className="max-w-4xl mx-auto text-sm md:text-base text-[#292524]">
                        You ain’t ever done something like this… we’ll arm you with axes, show  you the target, and share all our secrets for how to throw ‘em at the  board. Take on traditional bullseye or try your luck on the lanes with  one of our 13 Augmented Reality games. It’s like livin’ in the Year  3000! What battle will you take on?
                    </p>
                </section>
