        ...
        <>
            ...
            <div className="w-full bg-fixed bg-cover bg-center"
                ...
                <section className="text-center pt-12 px-4">
                    ...
                    <p style={{ fontFamily: 'Noir Semi' }} className="max-w-4xl mx-auto text-sm md:text-base text-[#292524]">
                        Drone soccer is taking off worldwide, and Drone Soccer  International (FIDA) is the go-to hub for official rules, global  competitions, and getting started. In the U.S., U.S. Drone Soccer is  leading the charge, focusing on STEM education, national rankings, and  expanding the sport. If you need gear or training resources, Drone  Sports, Inc. has everything from official drones to youth programs. 🚀
                    </p>
                </section>
                        ...
                        <div className="bg-black text-[#00AACB] w-full min-[820px]:w-[280px] p-4 space-y-4">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div style={{ fontFamily: 'Posterama2001W04' }} className="leading-[1.4]">
                                    ...
                                    <div className="text-lg min-[820px]:text-xl font-bold">9 Themes</div>
                                </div>
                            </div>
                        </div>
                    </motion.div>
