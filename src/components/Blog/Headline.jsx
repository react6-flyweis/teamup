...
const duck = '/assets/game.svg'
const texture = '/assets/texture.svg'
const headline = '/assets/headline.svg'
const headlines = '/assets/headline2.svg'
const Duckpin = () => {
            ...
            <div className="w-full bg-fixed bg-cover bg-center"
                ...
                <div className=" text-gray-800 py-8 px-4">
                    ...
                    <div className="max-w-4xl mx-auto text-left">
                        <ol className="list-decimal list-inside space-y-2 text-sm sm:text-base text-gray-800 font-medium">
